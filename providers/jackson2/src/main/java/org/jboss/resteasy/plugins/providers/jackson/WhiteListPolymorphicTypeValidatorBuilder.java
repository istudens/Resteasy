...
public class WhiteListPolymorphicTypeValidatorBuilder extends BasicPolymorphicTypeValidator.Builder
{
   ...
   private static final String BASE_TYPE_PROP = "jackson.deserialization.whitelist.allowIfBaseType.prefix";
   private static final String SUB_TYPE_PROP = "jackson.deserialization.whitelist.allowIfSubType.prefix";
